...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 pt-3">
      <nav
        className="max-w-7xl mx-auto bg-white rounded-2xl border border-gray-200"
      ...
      >
        <div className="px-4 sm:px-5">
          <div className="flex items-center justify-between h-[58px]">
            ...
            <Link href="/" className="flex items-center shrink-0">
              <Image src="/images/logo.png" alt="90 Days Freedom System" width={40} height={40} className="rounded-full" />
            </Link>
        ...
        {/* ── Mobile Menu ── */}
        {mobileOpen && (
          <div className="md:hidden border-t border-gray-100 px-4 py-4 space-y-3 rounded-b-2xl">
            {navLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
