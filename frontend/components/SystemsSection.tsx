...
function BulletList({ items }: { items: string[] }) {
  return (
    <ul className="space-y-2">
      {items.map((item) => (
        <li key={item} className="flex items-start gap-2.5 text-gray-700 text-sm leading-relaxed">
    ...
    <section className="py-16 sm:py-24  border-gray-200 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20 sm:space-y-28">
        ...
        <Reveal direction="up" className="text-center max-w-3xl mx-auto">
          <h2 className="font-heading font-bold text-3xl sm:text-4xl lg:text-5xl text-black uppercase tracking-wide mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <RevealGroup delay={0.1}>
            <RevealItem direction="up">
              <p className="text-black font-heading font-semibold text-xl leading-snug mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <RevealGroup delay={0.1}>
            <RevealItem direction="up">
              <h3 className="font-heading font-bold text-2xl sm:text-3xl text-black uppercase tracking-wide mb-4">
                OPERATIONAL SUPPORT
              </h3>
            </RevealItem>
            <RevealItem direction="up">
